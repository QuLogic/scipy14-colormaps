...
\begin{frame}[t]\frametitle{Lightness of matplotlib Colormaps}
    \begin{figure}[htbp]
        \centering
        \only<1>{
        \includegraphics[width=0.45\textwidth]{figures/Sequential}
        \includegraphics[width=0.45\textwidth]{figures/Sequential2}}
        \only<2>{
...
\begin{frame}[t]\frametitle{Lightness of matplotlib Colormaps}
    ...
    \begin{figure}[htbp]
        \centering
        \only<1>{
        \includegraphics[width=0.45\textwidth]{figures/Diverging}
        \includegraphics[width=0.45\textwidth]{figures/Qualitative}\\
        \includegraphics[width=0.45\textwidth]{figures/Miscellaneous}}
        \only<2>{
...
\begin{frame}[t]\frametitle{Improvement to Binary Colormap?}
    \begin{figure}[htbp]
        \centering
        \only<1>{\includegraphics[width=\textwidth]{figures/lSequential}}
...
\begin{frame}[t]\frametitle{Color Blindness}
    \begin{figure}[htbp]
        \includegraphics[width=0.49\textwidth]{figures/Sequential}
        \includegraphics[width=0.49\textwidth]{figures/SequentialDeuteranopia}
    \end{figure}
\end{frame}
\begin{frame}[t]\frametitle{Color Blindness}
    \begin{figure}[htbp]
